...
//     const totalAmount = cart.reduce((acc, item) => {
//       // Handle prices in ₹, removing only the ₹ symbol and commas, with fallback to 0 if parsing fails
//       let price = 0;
//       if (typeof item.price === 'string') {
//         price = parseFloat(item.price.replace('₹', '').replace(/,/g, '')) || 0;
//       } else if (typeof item.price === 'number') {
//         price = item.price; // Handle if price is already a number
//       }
...
//                   <p className="item-price"><strong>Price:</strong> ₹{parseFloat(item.price.replace('₹', '').replace(/,/g, '') || 0).toFixed(2)}</p>
//                 </div>
//               </li>
//             ))}
//           </ul>
